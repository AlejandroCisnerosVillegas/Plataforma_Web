<?php
	require 'rechazados.php';
?>
<?php
	require '../administrador/database/rechazados.php';
?>
<!-- ======================================================================================================== -->
<!doctype html>
<html lang="en">
...
<!-- Pagina Administrador CSS -->
    <link href="../administrador/assets/css/administrador09.css" rel="stylesheet"/>
<!-- ======================================================================================================== -->
<!-- CSS Externo Estilos -->
...
<!-- Barra de Navegacion - Superior -->
				<div class="container-fluid">
						<div class="navbar-header">
								...
								<a class="navbar-brand" href="#" style="color:#ffffff";>Usuarios postulados que fueron rechazados</a>
						</div>
...
<!-- Tabla de la Base de Datos -->
                    ...
                    <td><a href="../administrador/registros/rechazados/vista.php?id=<?php echo $row['IDUPAceptados'] ?>"><span <i class="pe-7s-look"></i></span></a></td>
                    <td><a href="vista.php?id=<?php echo $row['Direccion_UPRechazados'] ?>"><span <i class="pe-7s-news-paper"></i></span></a></td>
										<td><a href="../administrador/registros/rechazados/modificar.php?id=<?php echo $row['IDUPAceptados'] ?>"><span <i class="pe-7s-note"></i></span></a></td>
										<td><a href="../administrador/registros/rechazados/eliminar.php?id=<?php echo $row['IDUPAceptados'] ?>"><span <i class="pe-7s-trash"></i></span></a></td>
									</tr>
								<?php } ?>
							</tbody>
						</table>
...
<!-- Formulario General -->
		<div class="col-md-12">
				<div class="card">
						<div class="header">
								<h4 class="title" style="color:#ffffff";>Datos del usuario postulado que fue rechazado</h4>
						</div>
						<div class="content">
							<form method="POST" action="rechazados.php" autocomplete="off" name="formulario1">
<!-- ======================================================================================================== -->
