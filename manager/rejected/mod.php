			...
			<div class="row">
				<div class="col-md-12">
					<div class="form-group">
						...
						<textarea rows="5" class="form-control"  placeholder="Reporte sobre el estatus final del usuario" id="Reporte_UPRechazados" name="Reporte_UPRechazados" required value=""><?php echo $row['Reporte_UPRechazados'] ?></textarea>
					</div>
				</div>
			</div>
