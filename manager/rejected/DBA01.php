<?php
	require '../database/rechazados/modificar.php';
?>
<?php
	require '../database/rechazados.php';
?>
<!doctype html>
<html lang="en">
<head>
...
<!-- Pagina Administrador CSS -->
	<link href="../assets/css/dismissed.css" rel="stylesheet"/>
			...
			<nav class="navbar navbar-default navbar-fixed">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<a class="navbar-brand" style="color:#ffffff";>Usuarios Postulados que fueron Aceptados</a>
					</div>
...
<!-- Contenedor Principal -->
		    ...
		    <div class="container-fluid">
					<div class="col-md-12">
						...
						<FONT SIZE=6><b>Registro de los usuarios postulados que fueron rechazados</b></font>
						<br></br>
<!-- Barra de Busqueda -->
							<div class="row">
								<div class="col-md-10">
								...
								<table class="table table-stripeder" id="employee_table">
									...
									<tbody>
										<?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
											<tr>
												<td><b><?php echo $row['Titulo_UPRechazados'] ?></b></td>
												...
												<td style="cursor: pointer"><a data-id="<?php echo $row['IDUPAceptados'] ?>" class="openBtn2"><span <i class="pe-7s-look"></i></span></a></td>
												<td><a href="../../archivos/vista.php?id=<?php echo $row['Direccion_UPRechazados'] ?>"><span <i class="pe-7s-cloud-download"></i></span></a></td>
												<td style="cursor: pointer"><a data-id="<?php echo $row['IDUPAceptados'] ?>" class="openBtn3"><span <i class="pe-7s-note"></i></span></a></td>
												<td style="cursor: pointer"><a data-id="<?php echo $row['IDUPAceptados'] ?>" class="openBtn4"><span <i class="pe-7s-trash"></i></span></a></td>
											</tr>
										<?php } ?>
									</tbody>
								</table>
		...
		<div class="modal-content">
			<div class="login100-form-title" style="background-image: url(../assets/img/view.jpg);">
				<span class="login100-form-title-1">
					Información sobre el postulado rechazado
				</span>
			</div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="login100-form-title" style="background-image: url(../assets/img/modify.jpg);">
				<span class="login100-form-title-1">
					Reporte sobre el estatus final del postulado rechazado
				</span>
			</div>
			<div class="modal-body" style="background-color: #182c39">
			</div>
