<?php
	require '../database/rechazados/datos.php';
?>
<!doctype html>
<html lang="en">
<head>
...
<!-- Pagina Administrador CSS -->
	<link href="../assets/css/rejected.css" rel="stylesheet"/>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input disabled type="text" class="form-control"  placeholder="Fecha en que se postuló el usuario" id="Fecha_UPRechazados" name="Fecha_UPRechazados" value="<?php echo $row['Fecha_UPRechazados'] ?>">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input disabled type="text" class="form-control"  placeholder="Título de la Vacante" id="Titulo_UPRechazados" name="Titulo_UPRechazados" value="<?php echo $row['Titulo_UPRechazados'] ?>">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input disabled type="text" class="form-control"  placeholder="Correo Electrónico" id="Correo_UPRechazados" name="Correo_UPRechazados" value="<?php echo $row['Correo_UPRechazados'] ?>">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							<textarea rows="5" disabled class="form-control"  placeholder="Reporte sobre el estatus final del usuario" id="Reporte_UPRechazados" name="Reporte_UPRechazados" value=""><?php echo $row['Reporte_UPRechazados'] ?></textarea>
						</div>
					</div>
				</div>
