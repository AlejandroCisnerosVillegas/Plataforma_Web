...
$sql = "UPDATE institucion SET Nombre_Institucion='$Nombre_Institucion', Clave_Institucion='$Clave_Institucion', Nivel_Institucion='$Nivel_Institucion', Dependencia_Institucion='$Dependencia_Institucion', Turno_Institucion='$Turno_Institucion', Carreras_Institucion='$Carreras_Institucion', Vacantes_Institucion='$Vacantes_Institucion', Medios_Institucion='$Medios_Institucion', Estado_Institucion='$Estado_Institucion', Delegacion_Institucion='$Delegacion_Institucion', Colonia_Institucion='$Colonia_Institucion', Calle_Institucion='$Calle_Institucion', Nombre_Plantel= '$Nombre_Plantel' WHERE IDInstitucion='$id'";
