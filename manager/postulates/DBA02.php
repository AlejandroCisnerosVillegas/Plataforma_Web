<?php
	require '../database/postulados/rechazados_transferencia.php';
?>
<?php
	require '../database/postulados/postulados_transferencia.php';
?>
<?php
...
<!-- JavaScript de Notificacion -->
	<script src="../assets/js/rejected.js"></script>
</html>