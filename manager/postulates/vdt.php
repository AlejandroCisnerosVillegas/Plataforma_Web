...
<body>
	<div class="card">
		<div class="header">
			<h4 class="title" style="color:#ffffff";>Datos del Usuario Postulado</h4>
		</div>
		<div class="content">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input disabled type="text" class="form-control"  placeholder="Fecha en que se postuló el usuario" id="fecha" name="fecha" value="<?php echo $row['fecha'] ?>">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input disabled type="text" class="form-control"  placeholder="Título de la Vacante" id="titulo" name="titulo" value="<?php echo $row['titulo'] ?>">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input disabled type="text" class="form-control"  placeholder="Correo Electrónico" id="correo" name="correo" value="<?php echo $row['correo'] ?>">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
