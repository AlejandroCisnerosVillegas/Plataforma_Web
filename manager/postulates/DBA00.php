<?php
	require '../database/postulados/repostular_transferencia.php';
?>
<?php
	require '../database/postulados/repostular_transferencias.php';
?>
<?php
	require '../database/postulados.php';
?>
<!doctype html>
<html lang="en">
<head>
...
<!-- Pagina Administrador CSS -->
	<link href="../assets/css/postulation.css" rel="stylesheet"/>
			...
			<nav class="navbar navbar-default navbar-fixed">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<a class="navbar-brand" style="color:#ffffff";>Usuarios Postulados</a>
					</div>
...
<!-- Contenedor Principal -->
		    ...
		    <div class="container-fluid">
					<div class="col-md-12">
						...
						<FONT SIZE=6><b>Registro de los Usuarios Postulados</b></font>
						<br></br>
<!-- Barra de Busqueda -->
							<div class="row">
								<div class="col-md-10">
...
<!-- Boton de Registro -->
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-2">
										<button class="openBtn btn btn-primary">Re-postular Usuario Rechazado</button>
										<br></br>
									</div>
								</div>
							</div>
<!-- Tabla de la Base de Datos -->
							<div class="row table-responsive">
								<table class="table table-stripeder" id="employee_table">
									<thead>
										<tr>
											<th style="color:#000000";><FONT SIZE=3><b>Título de la Vacante</b></font></th>
											<th style="color:#000000";><FONT SIZE=3><b>Nombre del Usuario</b></font></th>
									...
									<tbody>
										<?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
											<tr>
												...
												<td style="cursor: pointer"><a data-id="<?php echo $row['id'] ?>" class="openBtn2"><span <i class="pe-7s-look"></i></span></a></td>
												<td><a href="../../archivos/vista.php?id=<?php echo $row['direccion'] ?>"><span <i class="pe-7s-cloud-download"></i></span></a></td>
												<td style="cursor: pointer"><a data-id="<?php echo $row['id'] ?>" class="openBtn3"><span <i class="pe-7s-check"></i></span></a></td>
												<td style="cursor: pointer"><a data-id="<?php echo $row['id'] ?>" class="openBtn4"><span <i class="pe-7s-close-circle"></i></span></a></td>
											</tr>
										<?php } ?>
									</tbody>
								</table>
		...
		<div class="modal-content">
			<div class="login100-form-title" style="background-image: url(../assets/img/register.jpg);">
				<span class="login100-form-title-1">
					Repostular Usuario a una Nueva Vacante
				</span>
			</div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="login100-form-title" style="background-image: url(../assets/img/view.jpg);">
				<span class="login100-form-title-1">
					Información sobre el Postulado
				</span>
			</div>
			<div class="modal-body" style="background-color: #182c39">
			</div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="login100-form-title" style="background-image: url(../assets/img/modify.jpg);">
				<span class="login100-form-title-1">
					¿Desea Aceptar la Postulación del Usuario?
				</span>
			</div>
			<div class="modal-body" style="background-color: #182c39">
			</div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="login100-form-title" style="background-image: url(../assets/img/remove.jpg);">
				<span class="login100-form-title-1">
					¿Desea Rechazar la Postulación del Usuario?
				</span>
			</div>
			<div class="modal-body" style="background-color: #182c39">
			</div>
...
<!-- JavaScript de Notificacion -->
	<script src="../assets/js/relocate.js"></script>
</html>