				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							<input  type="text" class="form-control"  placeholder="Título del Anuncio" id="Titulos_Vacantes" name="Titulos_Vacantes" value="<?php echo $row['Titulos_Vacantes'] ?>" required>
						</div>
					</div>
				</div>
					...
					<div class="col-md-6">
						<div class="form-group">
							<label style="color:#ffffff";><b>Color</b></label>
								<select id="quaternary" class="form-control" name="Seccion_Vacantes"  readonly>
					...
					<div class="col-md-6">
						<div class="form-group">
							<label style="color:#ffffff";><b>Municipio / Delegación / Alcaldía</b></label>
							 <input  type="text" class="form-control"  placeholder="Ingrese una Delegación" id="Delegacion_Vacantes" name="Delegacion_Vacantes" value="<?php echo $row['Delegacion_Vacantes'] ?>" required>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							<input  type="text" class="form-control"  placeholder="Cargo Disponible" id="Cargo_Vacantes" name="Cargo_Vacantes" value="<?php echo $row['Cargo_Vacantes'] ?>" required>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							<textarea rows="5"  class="form-control"  placeholder="Descripción de la Vacante" id="Descripcion_Vacantes" name="Descripcion_Vacantes" value="" required><?php echo $row['Descripcion_Vacantes'] ?></textarea>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							<input  type="text" class="form-control"  placeholder="Carrera Solicitada" id="Carrera_Vacantes" name="Carrera_Vacantes" value="<?php echo $row['Carrera_Vacantes'] ?>" required>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							<textarea rows="5"  class="form-control"  placeholder="Conocimientos Requeridos" id="Conocimientos_Vacantes" name="Conocimientos_Vacantes" value="" required><?php echo $row['Conocimientos_Vacantes'] ?></textarea>
						</div>
					</div>
				</div>
