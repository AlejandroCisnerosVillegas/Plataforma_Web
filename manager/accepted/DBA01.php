<?php
	require '../database/aceptados/modificar.php';
?>
<?php
	require '../database/aceptados.php';
?>
<!doctype html>
<html lang="en">
<head>
...
<!-- Pagina Administrador CSS -->
	<link href="../assets/css/granted.css" rel="stylesheet"/>
								...
								<tbody>
									<?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
										<tr>
											...
											<td><a href="../../archivos/vista.php?id=<?php echo $row['Direccion_UPAceptados'] ?>"><span <i class="pe-7s-cloud-download"></i></span></a></td>
		...
		<div class="modal-content">
			<div class="login100-form-title" style="background-image: url(../assets/img/view.jpg);">
				<span class="login100-form-title-1">
					Información sobre el postulado aceptado
				</span>
			</div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="login100-form-title" style="background-image: url(../assets/img/modify.jpg);">
				<span class="login100-form-title-1">
					Reporte sobre el estatus final del postulado aceptado
				</span>
			</div>
			<div class="modal-body" style="background-color: #182c39">
			</div>
