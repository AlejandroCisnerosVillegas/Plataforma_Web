<?php
	require '../database/usuarios/modificar_usuario.php';
?>
<?php
	require '../database/usuarios/modificar_usuarios.php';
?>
<?php
			...
			<nav class="navbar navbar-default navbar-fixed">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<a class="navbar-brand" style="color:#ffffff";>Usuarios</a>
					</div>
...
<!-- Contenedor Principal -->
		    ...
		    <div class="container-fluid">
					<div class="col-md-12">
						...
						<FONT SIZE=6><b>Registro de los Usuarios</b></font>
						<br></br>
<!-- Barra de Busqueda -->
						<div class="row">
							<div class="col-md-10">
								...
								<table class="table table-stripeder" id="employee_table">
									<thead>
										<tr>
											...
											<th style="color:#000000";><FONT SIZE=3><b>Nivel de Estudios</b></font></th>
									...
									<tbody>
										<?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
											<tr>
												...
												<td><b><?php echo $row['Nivel_DUsuario'] ?></b></td>
												<td><b><?php echo $row['Ciudad_DUsuario'] ?></b></td>
												<td><b><?php echo $row['Minicipio_DUsuario'] ?></b></td>
												<td style="cursor: pointer"><a data-id="<?php echo $row['Correo_DUsuario'] ?>" class="openBtn2"><span <i class="pe-7s-look"></i></span></a></td>
												<td style="cursor: pointer"><a data-id="<?php echo $row['Correo_DUsuario'] ?>" class="openBtn3"><span <i class="pe-7s-pen"></i></span></a></td>
												<td style="cursor: pointer"><a data-id="<?php echo $row['Correo_DUsuario'] ?>" class="openBtn4"><span <i class="pe-7s-trash"></i></span></a></td>
											</tr>
										<?php } ?>
									</tbody>
								</table>
