<?php
	require '../database/inhabilitados/habilitados.php';
?>
<?php
	require '../database/inhabilitados/eliminar.php';
?>
<?php
	require '../database/inhabilitados.php';
?>
<!doctype html>
<html lang="en">
<head>
			...
			<nav class="navbar navbar-default navbar-fixed">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<a class="navbar-brand" style="color:#ffffff";>Vacantes Inhabilitadas</a>
					</div>
...
<!-- Contenedor Principal -->
		    ...
		    <div class="container-fluid">
					<div class="col-md-12">
						...
						<FONT SIZE=6><b>Registro de las Vacantes Inhabilitadas</b></font>
						<br></br>
<!-- Barra de Busqueda -->
							<div class="row">
								<div class="col-md-10">
...
<!-- Agregar un Nuevo Registro -->
							<div class="col-md-10">
								<div class="row">
									<div class="col-md-5">
										<a href="../vacancies/"><button type="button" class="btn btn-primary"><b></b>Vacantes Habilitadas</button></a>
									</div>
								</div>
							</div>
									...
									<tbody>
										<?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
											<tr>
												...
												<td style="cursor: pointer"><a data-id="<?php echo $row['IDVacantes'] ?>" class="openBtn3"><span <i class="pe-7s-power"></i></span></a></td>
												<td style="cursor: pointer"><a data-id="<?php echo $row['IDVacantes'] ?>" class="openBtn4"><span <i class="pe-7s-trash"></i></span></a></td>
											</tr>
										<?php } ?>
									</tbody>
								</table>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="login100-form-title" style="background-image: url(../assets/img/modify.jpg);">
				<span class="login100-form-title-1">
					¿Seguro que desea habilitar esta vacante?
				</span>
			</div>
			<div class="modal-body" style="background-color: #182c39">
			</div>
...
<!-- JavaScript de Notificacion -->
	<script src="../assets/js/enabled.js"></script>
</html>