<?php
	require '../database/contactos/modificar.php';
?>
<?php
	require '../database/contactos.php';
?>
<!doctype html>
<html lang="en">
<head>
			...
			<nav class="navbar navbar-default navbar-fixed">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<a class="navbar-brand" style="color:#ffffff";>Contactos</a>
					</div>
		    ...
		    <div class="container-fluid">
					<div class="col-md-12">
						<div class="card card-plain">
							<FONT SIZE=6><b>Registro del Contacto</b></font>
							<br></br>
<!-- Barra de Busqueda -->
							<div class="row">
								<div class="col-md-10">
...
<!-- Boton de Registro -->
							<div class="col-md-12">
							 <div class="row">
								 <div class="col-md-2">
									 <button class="openBtn btn btn-primary">Registrar Nuevo Contacto</button>
								 <br></br>
								 </div>
							 </div>
							</div>
<!-- Tabla de la Base de Datos -->
							<div class="row table-responsive">
								<table class="table table-stripeder" id="employee_table">
									<thead>
										<tr>
											<th style="color:#000000";><FONT SIZE=3><b>Nombre</b></font></th>
											<th style="color:#000000";><FONT SIZE=3><b>Empresa o Institución</b></font></th>
											<th style="color:#000000";><FONT SIZE=3><b>Correo</b></font></th>
										</tr>
									</thead>
									<tbody>
										<?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
											<tr>
												<td><b><?php echo $row['Nombre_Contacto'] ?></b></td>
												<td><b><?php echo $row['Emp_Inst_Contacto'] ?></b></td>
												<td><b><?php echo $row['Correo_Contacto'] ?></b></td>
												<td style="cursor: pointer"><a data-id="<?php echo $row['IDContacto'] ?>" class="openBtn2"><span <i class="pe-7s-look"></i></span></a></td>
												<td style="cursor: pointer"><a data-id="<?php echo $row['IDContacto'] ?>" class="openBtn3"><span <i class="pe-7s-pen"></i></span></a></td>
												<td style="cursor: pointer"><a data-id="<?php echo $row['IDContacto'] ?>" class="openBtn4"><span <i class="pe-7s-trash"></i></span></a></td>
											</tr>
										<?php } ?>
									</tbody>
								</table>
