<?php
	require '../database/administrador/modificar.php';
?>
<?php
	require '../database/administrador.php';
?>
<!doctype html>
<html lang="en">
<head>
			...
			<nav class="navbar navbar-default navbar-fixed">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<a class="navbar-brand" style="color:#ffffff";>Administrador</a>
					</div>
...
<!-- Contenedor Principal -->
		    ...
		    <div class="container-fluid">
					<div class="col-md-12">
						...
						<FONT SIZE=6><b>Registro del Administrador</b></font>
						<br></br>
<!-- Barra de Busqueda -->
							<div class="row">
								<div class="col-md-10">
...
<!-- Boton de Registro -->
							<div class="col-md-12">
							 <div class="row">
								 <div class="col-md-2">
									 <button class="openBtn btn btn-primary">Registrar Nuevo Administrador</button>
								 <br></br>
								 </div>
							 </div>
							</div>
								...
								<table class="table table-stripeder" id="employee_table">
									...
									<tbody>
										<?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
											<tr>
												<td><b><?php echo $row['Correo_Usuario'] ?></b></td>
												<td style="cursor: pointer"><a data-id="<?php echo $row['IDUsuario'] ?>" class="openBtn3"><span <i class="pe-7s-pen"></i></span></a></td>
												<td style="cursor: pointer"><a data-id="<?php echo $row['IDUsuario'] ?>" class="openBtn4"><span <i class="pe-7s-trash"></i></span></a></td>
											</tr>
										<?php } ?>
									</tbody>
								</table>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
			<div class="login100-form-title" style="background-image: url(../assets/img/modify.jpg);">
				<span class="login100-form-title-1">
					Modificar la Información del Administrador
				</span>
			</div>
      <div class="modal-body" style="background-color: #182c39">
      </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
			<div class="login100-form-title" style="background-image: url(../assets/img/remove.jpg);">
				<span class="login100-form-title-1">
					¿Seguro que desea eliminar este Administrador?
				</span>
			</div>
      <div class="modal-body" style="background-color: #182c39">
      </div>
