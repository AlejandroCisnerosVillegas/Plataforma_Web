<?php
require 'database/vacantes_proyectos.php';
?>
<!--===============================================================================================-->
<!DOCTYPE html>
<html lang="en">
...
<!-- Vacante General -->
    <div class="unit-5 overlay" style="background-image: url('images/vacantes_general.jpg');">
      <div class="container text-center">
        ...
        <p class="mb-0 unit-6"><a href="vacantes_principal.php">Inicio</a> <span class="sep">></span> <span>Proyectos</span></p>
      </div>
    </div>
<!--===============================================================================================-->
      ...
      <div class="container">
        <div class="row justify-content-start text-left mb-5">
          <div class="col-md-9" data-aos="fade">
            ...
            <h2 class="font-weight-bold text-black">Todas Nuestras Vacantes - Proyectos</h2>
          </div>
        </div>
<!--===============================================================================================-->
<!--===============================================================================================-->
